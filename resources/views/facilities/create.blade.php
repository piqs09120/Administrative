...
<head>
  ...
  <title>Add New Facility - Soliera</title>
      ...
      <header class="bg-white shadow-sm border-b border-gray-200 px-6 py-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <h1 class="text-3xl font-bold text-gray-800 ml-4">Add New Facility</h1>
          </div>
              ...
              <form action="{{ route('facilities.store') }}" method="POST">
                ...
                <div class="card-actions justify-end">
                  ...
                  <button type="submit" class="btn btn-primary">
                    <i data-lucide="save" class="w-4 h-4 mr-2"></i>Create Facility
                  </button>
                </div>
              </form>
            </div>
